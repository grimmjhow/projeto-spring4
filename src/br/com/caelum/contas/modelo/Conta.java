...
public class Conta {
	...
	@NotEmpty(message="{validation.conta.descricao.obrigatorio}") 
	@Size(max=5,message="{validation.conta.descricao.tamanho}")
	...
	@NotNull(message="{validation.conta.dataPagamento}")
